---
title: "John count - individual random effect - Bayes"
author: "Yuxin Zou"
date: 2018-4-14
output: 
  html_document:
...
```{r save}
saveRDS(list(beta = beta_class, sebeta = sebeta_class, t = t_class, df = df_class), '../output/John18_IndRan_limmaBayes.rds')
```
