...
delta.1[abs(delta.1) <= 1e-10] = 0
delta.50[abs(delta.50) <= 1e-10] = 0
N = sum(delta.1 == 0)
...
for(t in 1:length(thresh.seq)){
  ...
  mashcontrast.50[t,] = c(CS_S(mashcontrast.model.50.full, thresh.seq[t], delta.50)/Tr, N_S(mashcontrast.model.50.full, thresh.seq[t],delta.50)/N)
  Indep.50[t,] = c(CS_S(Indep.model.50.full, thresh.seq[t], delta.50)/Tr,  N_S(Indep.model.50.full, thresh.seq[t],delta.50)/N)
}
```
