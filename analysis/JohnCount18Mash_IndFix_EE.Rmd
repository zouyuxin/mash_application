---
title: "John Count 18 Mash - IndFix - EE"
author: "Yuxin Zou"
date: 2018-4-14
output: 
  html_document:
...
```{r data}
data = readRDS('../output/John18_IndFix_limma.rds')
...
saveRDS(cov_ed(mash.data.ed, U.dd), '../output/JohnCount18_IndFix_mash_EE_Cov.rds')
```

## Mash model:
```{r, echo=FALSE}
U.ed = readRDS('../output/JohnCount18_IndFix_mash_EE_Cov.rds')
```

```{r mash, eval=FALSE}
saveRDS(mash(mash.data.diff, c(U.c, U.ed), algorithm.version = 'R'), '../output/JohnCount18_IndFix_mash_model_EE.rds') 
```

# Result
```{r}
mash.model = readRDS('../output/JohnCount18_IndFix_mash_model_EE.rds')
```
